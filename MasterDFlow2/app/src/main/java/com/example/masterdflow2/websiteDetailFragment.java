        ...
        if (mItem != null) {
          ...
          // ImageView image = rootView.findViewById(R.id.image);
            ...
            if (mItem.id.equals("1")) {
                ...
                ((TextView) rootView.findViewById(R.id.image_description)).setText(mItem.content);
                ((ImageView) rootView.findViewById(R.id.image)).setImageResource(R.drawable.matchamisu);
               // ImageView image= (ImageView) rootView.findViewById(R.id.image);
               // Glide.with(this).load("https://uncutrecipes.com/Images-Recipes-Japanese/Matcha-Mille-Crepe-Cake-Recipe.jpg").into((ImageView) rootView.findViewById(R.id.image));
            ...
            if (mItem.id.equals("2")) {
                rootView = inflater.inflate(R.layout.activity_gallery, container, false);
                ((TextView) rootView.findViewById(R.id.image_description)).setText(mItem.content);
                ((ImageView) rootView.findViewById(R.id.image)).setImageResource(R.drawable.image2);
                //Glide.with(this).load("https://c1.staticflickr.com/1/694/33375078895_b806a2d80b_o.jpg").into((ImageView) rootView.findViewById(R.id.image));
            }
            if (mItem.id.equals("3")) {
                rootView = inflater.inflate(R.layout.activity_gallery, container, false);
                ((TextView) rootView.findViewById(R.id.image_description)).setText(mItem.content);
                ((ImageView) rootView.findViewById(R.id.image)).setImageResource(R.drawable.blueberry);
            ...
            if (mItem.id.equals("4")) {
                rootView = inflater.inflate(R.layout.activity_gallery, container, false);
                ((TextView) rootView.findViewById(R.id.image_description)).setText(mItem.content);
                ((ImageView) rootView.findViewById(R.id.image)).setImageResource(R.drawable.dalgona);
            ...
            if (mItem.id.equals("5")) {
                rootView = inflater.inflate(R.layout.activity_gallery, container, false);
                ((TextView) rootView.findViewById(R.id.image_description)).setText(mItem.content);
                ((ImageView) rootView.findViewById(R.id.image)).setImageResource(R.drawable.rashberry);
            ...
            if (mItem.id.equals("7")) {
                rootView = inflater.inflate(R.layout.activity_gallery, container, false);
                ((TextView) rootView.findViewById(R.id.image_description)).setText(mItem.content);
                ((ImageView) rootView.findViewById(R.id.image)).setImageResource(R.drawable.pie);
